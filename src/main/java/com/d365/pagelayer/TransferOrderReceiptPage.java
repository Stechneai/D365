...
public class TransferOrderReceiptPage extends MasterClass {
	...
	@FindBy(xpath = "//span[text()='Transfer Journal Barcode']")
	private WebElement tagsclick;

	public WebElement labelclick() {
		return tagsclick;
	}
...
//	}
	...
	@FindBy(xpath = "//input[contains(@id,'AcxBarcodeScanning') and contains(@id,'SeTag_input')]")
	private WebElement tagno;
	...
	@FindBy(xpath = "(//button[contains(@id,'inventtransferorder_') and contains(@id,'_ButtonInventTransferShip')])")
...
//		@FindBy(name = "ButtonInventTransferShip")
//		private WebElement shiptransfer;
//
//		public WebElement btnShipTransfer() {
//			return shiptransfer;
...
//		}
	...
	// No of boxes
	// input[contains(@id,'inventtransferorder')and
	// contains(@id,'_InventTransferTable_NoofBoxes_input')]
	...
	private WebElement noofboxesl;

	public WebElement labelNoOfBoxes() {
		return noofboxesl;
